      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: 'calc(100vh - 200px)' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 13, color: T.dim, lineHeight: 1.7, maxWidth: 320 }}>
            Click the <span style={{ color: T.yellow }}>☆</span> star next to any card in
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 12, alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              ...
              cursor: 'pointer', borderRadius: 6, padding: '7px 14px', fontSize: 12,
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    color: T.yellow, fontSize: 18, padding: 0,
